...
import (
	...
	"github.com/rogpeppe/go-internal/cache/cacheprog"
	"github.com/rogpeppe/go-internal/internal/quoted"
)
...
func startCacheProg(progAndArgs string, fuzzDirCache Cacher) Cacher {
	if fuzzDirCache == nil {
